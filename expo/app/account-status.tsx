...
const createStyles = (theme: AppTheme) => StyleSheet.create({
  ...
  heroTitle: { fontSize: 18, fontWeight: '700', color: theme.colors.text, marginBottom: 8, textAlign: 'center' },
  heroDesc: { fontSize: 14, color: theme.colors.textTertiary, textAlign: 'center' },
  ...
  cardValue: { fontSize: 15, color: theme.colors.text, fontWeight: '500', textTransform: 'capitalize' },
  ...
  statusTagText: { fontSize: 13, color: theme.colors.success, fontWeight: '600' },
});
