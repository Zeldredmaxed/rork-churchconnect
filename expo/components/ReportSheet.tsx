...
export default function ReportSheet({
  ...
  const handleBack = () => {
    ...
    if (step === 'sub-reason') {
      ...
      if (selectedCategory?.subReasons) {
        setStep('sub-reason');
      } else {
        setStep('reason');
      }
  ...
  const handleSelectCategory = (category: ReportCategory) => {
    ...
    if (category.subReasons && category.subReasons.length > 0) {
      setStep('sub-reason');
    } else {
      setStep('preview');
    }
  ...
  const subReasonLabel = selectedCategory?.subReasons?.find(
    (s) => s.id === selectedSubReason
  )?.label;
    ...
    <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
      ...
      {selectedCategory?.subReasons?.map((sub) => (
        <TouchableOpacity
          key={sub.id}
          style={styles.reasonRow}
          onPress={() => handleSelectSubReason(sub.id)}
          activeOpacity={0.6}
        >
        ...
        <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
          <View style={styles.previewHeader}>
            <View style={styles.previewAvatarRow}>
              ...
              <View>
                <Text style={styles.previewMeta}>Report preview</Text>
              </View>
            </View>
          </View>
    ...
    <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
      <View style={styles.submittedSection}>
        ...
        <Text style={styles.submittedDescription}>
          While you wait for our decision, we'd like you to know that there are other steps that you
          can take now.
        </Text>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Text style={styles.toggleStatusLink}>
            {showReportStatus ? 'Hide report status' : 'Show report status'}
          </Text>
        </TouchableOpacity>
          ...
          <View style={styles.statusTimeline}>
            <View style={styles.statusStep}>
              ...
              <View style={styles.statusStepContent}>
                ...
                <Text style={styles.statusStepDesc}>
                  We either use technology or a review team to remove anything that doesn't follow
                  our standards as quickly as possible.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.statusStep}>
              ...
              <View style={styles.statusStepContent}>
                ...
                <Text style={styles.statusStepDesc}>
                  We'll send you a notification to view the outcome in your support requests as soon
                  as possible.
                </Text>
              </View>
            </View>
